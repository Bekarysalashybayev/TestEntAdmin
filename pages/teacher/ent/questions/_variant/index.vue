<template>
  <div class="page">
    <div class="page-body">
<!--      <path-main />-->
      <nuxt-link class="add-button question-add" v-if="isCompleted" :to="{path: '/teacher/ent/questions/'+variantID+'/add'}">
        Добавить вопрос
      </nuxt-link>
      <div class="questions">
        <div class="question-item" v-for="(question, i) in questions" :key="question.id">
          ...
          <div class="question-item-actions">
            <nuxt-link :to="{path: '/teacher/ent/questions/'+variantID+'/edit/' + question.id}" class="edit">Изменить</nuxt-link>
